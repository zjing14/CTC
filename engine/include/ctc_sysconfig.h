...
class SysConfig {
    public:
		...
		std::string getLogFileName() { return _log_file; }
		std::string getWorkDir() { return _work_dir; }
		std::string getPluginDir() { return _plugin_dir; }
		std::string getWorkflowDir() { return _workflow_dir; }
		bool getVerbose() { return _verbose; }
		bool getDebug() { return _debug; }

        void setVerbose(bool flag) { _verbose = flag; }
        void setDebug(bool flag) { _debug = flag; }
        void setLogFile(const std::string& file) { _log_file = file; }
        void setWorkDir(const std::string& dir) { _work_dir = dir; }
        void setPluginDir(const std::string& dir) { _plugin_dir = dir; }
        void setWorkflowDir(const std::string& dir) { _workflow_dir = dir; }
